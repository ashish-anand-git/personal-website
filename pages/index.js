    ...
    <>
      <>
        ...
        <Head>
          ...
          <title>Ashish Anand - Developer | Coder | Software Geek</title>
        ...
        <div>
                ...
                <div className="pt-8 sm:pt-10 lg:pl-8 lg:pt-0">
                  ...
                  <div className="flex flex-col justify-center pt-3 sm:flex-row sm:pt-5 lg:justify-start">
                    ...
                    <div className="flex items-center justify-center pt-5 pl-2 sm:justify-start sm:pt-0">
                      ...
                      <Link href="https://twitter.com/bluedrone2" className="pl-4">
                        <i className="bx bxl-twitter text-2xl text-white hover:text-yellow"></i>
                      </Link>
                      {/* <Link href="/" className="pl-4">
                        <i className="bx bxl-dribbble text-2xl text-white hover:text-yellow"></i>
                      </Link> */}
                      <Link href="https://www.linkedin.com/in/ashish-anand-346674230" className="pl-4">
            ...
            <div className="container flex flex-col items-center py-16 md:py-20 lg:flex-row">
              <div className="w-full text-center sm:w-3/4 lg:w-3/5 lg:text-left">
                ...
                <h4 className="pt-6 font-header text-xl font-medium text-black sm:text-2xl lg:text-3xl">
                  I'm Ashish Anand, a Web Developer & student
                </h4>
                <p className="pt-6 font-body leading-relaxed text-grey-20">
                  I am currently studying computer Science from National
                  Institute of Technology, Warangal.
                </p>
                <p className="pt-6 font-body leading-relaxed text-grey-20">
                  I am a web developer and am familiar with HTML, CSS and
                  JavaScript libraries like REactJs, NextJs,Node Js etc.
                </p>
                <p className="pt-6 font-body leading-relaxed text-grey-20">
                  This portfolio website is made with NextJs for Frontend ans
                  Sanity io for backend along with using Tailwind CSS for
                  designing.
                </p>
                ...
                <div>
                  <div className="flex items-end justify-between">
                    <h4 className="font-body font-semibold uppercase text-black">
                      C++, Algorithms and Data Structure, MySQL
                    </h4>
          ...
          <div className="container py-16 md:py-20" id="portfolio">
            ...
            <div className="mx-auto grid w-full grid-cols-1 gap-8 pt-12 sm:w-3/4 md:gap-10 lg:w-full lg:grid-cols-2">
              ...
              >
                <img
                  src="/assets/img/portfolio-website.jpg"
                  className="w-full shadow"
                  alt="portfolio image"
                />
              </Link>
              <Link
                href="https://used-car-price-analysis.herokuapp.com"
                className="mx-auto transform transition-all hover:scale-105 md:mx-0"
              >
                <img
                  src="/assets/img/car-valuation.jpg"
                  className="w-full shadow"
              ...
              <div className="mx-auto w-full sm:w-3/4 lg:w-full">
                ...
                <div className="flex flex-wrap items-center justify-center pt-4 sm:pt-4">
                  <span className="m-8 block">
                    <img
                      src="/assets/img/reactjs-img1.png"
                      alt="ReactJs"
                  ...
                  <span className="m-8 block">
                    <img
                      src="/assets/img/express-img.png"
                      alt="ExpressJs"
                      className="mx-auto block h-12 w-auto"
                    />
                  </span>
                  ...
                  <span className="m-8 block">
                    <img
                      src="/assets/img/mongodb-img.png"
                      alt="MongoDB"
                      className="mx-auto block h-12 w-auto"
                    />
                  </span>
          ...
          <div className="container py-16 md:py-20" id="contact">
            ...
            <div className="flex flex-col pt-16 lg:flex-row">
              ...
              <div className="w-full border-l-2 border-t-0 border-r-2 border-b-2 border-grey-60 px-6 py-6 sm:py-8 lg:w-1/3 lg:border-l-0 lg:border-t-2">
                ...
                <p className="pt-2 text-left font-body font-bold text-primary lg:text-lg">
                  NIT WARANGAL, Hanamkonda, Warangal
                </p>
              </div>
            </div>
          </div>
